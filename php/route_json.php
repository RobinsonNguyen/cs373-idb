<?php
    ...
    mysqli_stmt_bind_param($st, 'ssssssssbb', $route_name, $region_name, $nexit, $sexit, $eexit, $wexit, $accessto, $mindesc, $maindesc, $trivia);
